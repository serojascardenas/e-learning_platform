								...
								<Col md={8}>
									<ListGroup variant="flush">
										...
										<ListGroup.Item>
											...
											{order.isPaid ? <Message variant="success">Fecha de Pago: {order.paidAt}</Message> : <Message variant="danger">El pago todavía está pendiente</Message>}
										</ListGroup.Item>
										<ListGroup.Item>
														...
														{order.orderItems.map((item, idx) => (
															<ListGroup.Item key={idx}>
																<Row>
																	...
																	<Col md={4}>
																		<Text textSize={0.95}>€{item.price.amount} + {0.05*100}% = €{(item.price.amount + (0.05 * item.price.amount)).toFixed(2)}</Text>
																	</Col>
																</Row>
															</ListGroup.Item>
														))}
